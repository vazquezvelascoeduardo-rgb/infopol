...
//
// Buit a propòsit. Aquest endpoint només ha de servir novetats verificades
// contra una font oficial (BOE, DOGC o el Servei Català de Trànsit), amb
// l'enllaç a la font a `url`. Fins que no hi hagi aquesta connexió no s'hi
// publica res: una novetat legislativa inventada és pitjor que cap novetat.
const NEWS = [];
