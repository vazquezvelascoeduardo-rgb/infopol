// tokens.jsx — InfoPol design tokens
// Original visual system inspired by the multicolor category language seen in
// the InfoPol web. Mobile-first, gamified academy vibes (Duolingo-leaning),
// serious operativa vibes (clear, confident, fast to scan).

const TOKENS = {
  // Surfaces
  bg: '#F6F4EF',          // warm off-white (terracota direction)
  card: '#FFFFFF',
  ink: '#13131A',         // near-black with cool tilt
  inkSoft: '#3A3A45',
  inkMuted: '#7A7A85',
  inkFaint: '#B8B8C0',
  hairline: 'rgba(19,19,26,0.08)',
  hairlineStrong: 'rgba(19,19,26,0.14)',

  // Brand — InfoPol uses category color. We define a multi-accent palette,
  // each card/section owns a hue. Saturations harmonised oklch-style.
  cat: {
    leyes:    { solid: '#E89421', soft: '#FBE7C2', ink: '#6B3F08' },   // ámbar
    operativa:{ solid: '#3B6BF5', soft: '#D8E2FE', ink: '#0E2B7A' },   // azul
    transito: { solid: '#9C4FE0', soft: '#EBDAFB', ink: '#4A1B7A' },   // morado
    alcohol:  { solid: '#E04F5F', soft: '#FBDADC', ink: '#7A1B22' },   // rojo
    atajos:   { solid: '#1FB286', soft: '#CDF0E1', ink: '#0B5A3D' },   // verde
    tests:    { solid: '#3B6BF5', soft: '#D8E2FE', ink: '#0E2B7A' },   // azul tests
    academia: { solid: '#FF7A1A', soft: '#FFE0CB', ink: '#7A2E04' },   // terracota / academia
    physical: { solid: '#0BB4C2', soft: '#CCEEF1', ink: '#0A4F56' },   // teal
    psico:    { solid: '#F0B400', soft: '#FCEFB8', ink: '#5C4400' },   // mostaza
  },
  ...
  shadow: {
    ...
    inset: 'inset 0 -3px 0 rgba(19,19,26,0.08)',  // duo-style 3D button bottom
  },
};

// ---- Inline icon set (stroke-based, no external deps) ----
