...
const NEWS = [
  { date: '08·16', tag: 'Internacional', title: 'Veneçuela allibera 131 presos polítics sota la pressió internacional', desc: 'El règim de Maduro anuncia l\'excarceració de 131 detinguts polítics. El govern espanyol és interpel·lat sobre la seva postura.', url: 'https://www.periodistadigital.com/periodismo/20260816/10-claves-politicas-domingo-16-agosto-2026-sanchez-ausente-ceuta-ruido-madrid-noticia-689405238413/' },
  { date: '08·16', tag: 'Policial · CAT', title: 'Mossos detenen sis lladres de cadenes amb 208 antecedents en el dispositiu Kanpai Càtena', desc: 'Operació centrada en robatoris de joies a Barcelona. Gairebé un centenar de persones identificades.', url: 'https://metropoliabierta.elespanol.com/sucesos/20260815/golpe-ladrones-cadenas-mossos-detienen-delincuentes-barcelona-antecedentes/1003742787078_0.html' },
  { date: '08·16', tag: 'Esports · FCB', title: 'El Barça oficialitza Anthony Gordon i negocia el fitxatge de Rodri', desc: '80M€ per al davanter del Newcastle. Converses obertes amb el Man. City per Rodri. Lewandowski marxa a la MLS.', url: 'https://www.futbolfantasy.com/laliga/equipos/barcelona/mercado-fichajes/verano-2026' },
  { date: '08·16', tag: 'Economia', title: 'Habitatge a Espanya: 2.933 €/m² al juliol, rècord històric (+13,1% interanual)', desc: 'Tots els territoris registren pujades. Cantàbria encapçala amb +18,2%. Mercat sense senyals de desacceleració.', url: 'https://www.coaalmeria.com/2026/08/12/informe-idealista-precios-venta-en-espana-jul-2026/' },
  { date: '08·16', tag: 'Tecnologia · CAT', title: 'Barcelona, futur hub de computació quàntica més gran d\'Europa', desc: 'Oxford Quantum Circuits inverteix 92M€ a Barcelona. BSC-CNS i ICFO lideren un sector estimat en 150.000M€ el 2040.', url: 'https://www.thenewbarcelonapost.com/barcelona-acogera-hub-computacion-cuantica-mas-grande-europa/' },
  { date: '08·16', tag: 'Política', title: 'Sánchez en silenci: crisi al PSOE de Ceuta i frents oberts a l\'agost', desc: 'Pressió migratòria a Ceuta i dissidència interna al PSOE mentre el president es manté absent del debat públic.', url: 'https://www.periodistadigital.com/periodismo/20260816/10-claves-politicas-domingo-16-agosto-2026-sanchez-ausente-ceuta-ruido-madrid-noticia-689405238413/' },
