    ...
    <div className="screen">
      ...
      <div style={{ padding: '14px 0 0' }}>
        ...
        <div style={{ padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          {news.map((n, i) => (
            <div key={n.id || i} style={{ background: '#fff', borderRadius: T.r.md, padding: 14, borderLeft: `2px solid ${T.cat.operativa.solid}`, boxShadow: T.shadow.card }}>
              ...
              {n.url && (
                <a href={n.url} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', marginTop: 6, fontSize: 11, color: T.cat.operativa.solid, fontWeight: 700, textDecoration: 'none' }}>
                  Llegir notícia →
                </a>
              )}
            </div>
