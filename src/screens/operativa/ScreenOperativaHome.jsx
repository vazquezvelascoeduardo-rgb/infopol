        ...
        <div style={{ padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          {news.map((n, i) => (
            ...
            >
              ...
              {n.url && (
                <div style={{ fontSize: 10.5, color: T.cat.operativa.solid, marginTop: 6, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          {news.length === 0 && (
            <div style={{ padding: 20, textAlign: 'center', color: T.inkMuted, fontSize: 12 }}>Carregant notícies…</div>
          )}
        </div>
      </div>
    </div>
