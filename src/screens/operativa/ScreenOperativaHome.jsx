      ...
      <div style={{ padding: '14px 0 0' }}>
        ...
        <div style={{ padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          {NEWS.slice(0, 5).map((n, i) => (
            <div
              key={n.id || i}
              onClick={n.url ? () => window.open(n.url, '_blank', 'noopener,noreferrer') : undefined}
            ...
            >
              ...
              {n.url && (
                <div style={{ marginTop: 6, fontSize: 11, color: T.cat.operativa.solid, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 3 }}>
                  Llegir més <Icon name="arrow-right" size={11} color={T.cat.operativa.solid} />
                </div>
              )}
            </div>
          ))}
