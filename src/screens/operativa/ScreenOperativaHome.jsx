  ...
  return (
    <div className="screen">
      ...
      <div style={{ padding: '14px 0 0' }}>
        <SectionHead kicker="Actualitat" kickerColor={T.cat.operativa.solid} title="Últimes notícies" action="Tot →" />
        <div style={{ padding: '0 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          {news.map((n) => (
            <div key={n.id} style={{ background: '#fff', borderRadius: T.r.md, padding: 14, borderLeft: `2px solid ${T.cat.operativa.solid}`, boxShadow: T.shadow.card }}>
              ...
              {n.url && (
                <a
                  ...
                  style={{ display: 'inline-block', marginTop: 8, fontSize: 11, fontWeight: 700, color: T.cat.operativa.solid, textDecoration: 'none' }}
                >
                  Llegir més →
                </a>
              )}
