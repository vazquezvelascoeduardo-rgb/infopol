...
const DICT: Record<Locale, Dict> = {
  es: {
    ...
    'cultura.badge': 'Tests · oposiciones',
    'cultura.testsSubtitle': 'Banco de preguntas oficial (ISPC) por materia. Empieza con un test mixto o practica una materia concreta.',
    'cultura.subjects': 'materias',
    'cultura.zoneEyebrow': 'BANCO DE PREGUNTAS',
    'cultura.zoneTitle': 'Practica con tests de cultura general',
    'cultura.zoneSubtitle': '{n} preguntas oficiales del banco ISPC. Empieza por un test mixto de todas las materias o elige una concreta.',
    'cultura.allTag': 'TEST RÁPIDO · MIX',
    'cultura.allTitle': 'Todas las materias',
    'cultura.allSub': 'Test mezclado con preguntas de TODAS las materias de cultura general. Mide tu nivel global.',
    'cultura.orBySubject': 'o elige una materia concreta',
