...
const DICT: Record<Locale, Dict> = {
  es: {
    ...
    'test.session.confirmFinish': 'Quedan {n} preguntas sin contestar (cuentan como 0). ¿Acabar el test ahora igualmente?',
  ...
  ca: {
    ...
    'test.session.confirmFinish': "Queden {n} preguntes sense contestar (compten com a 0). Acabar el test ara igualment?",
