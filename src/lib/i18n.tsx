...
const DICT: Record<Locale, Dict> = {
  es: {
    ...
    'operativa.matricules.title': 'Matrículas',
    'operativa.matricules.desc': 'Tipos, formato actual y provincial, especiales, oficiales, diplomáticas, colores y actuación.',
    'operativa.matricules.indexLabel': 'Ir a sección',
    'operativa.matricules.disclaimer': 'Referencia rápida orientativa. Verifica siempre la base legal vigente y coordina con DGT/Trànsit antes de actuar.',
  ...
  ca: {
    ...
    'operativa.matricules.title': 'Matrícules',
    'operativa.matricules.desc': 'Tipus, format actual i provincial, especials, oficials, diplomàtiques, colors i actuació.',
    'operativa.matricules.indexLabel': 'Ves a secció',
    'operativa.matricules.disclaimer': "Referència ràpida orientativa. Verifica sempre la base legal vigent i coordina amb DGT/Trànsit abans d'actuar.",
