...
const DICT: Record<Locale, Dict> = {
  es: {
    ...
    'test.list.repasDescAll': '{n} preguntas guardadas. Vuelve cuando toque repasar.',
    'test.list.repasDescMastered': '¡Bien hecho! Has dominado {n} preguntas. Sigue practicando para acumular más.',
    'test.list.repasDueShort': 'pendientes',
    'test.list.repasTotalShort': 'guardadas',
    'test.list.repasMasteredShort': 'dominadas',
    'test.repas.title': 'Repaso de fallos',
    'test.repas.poolStatus': '{n} preguntas listas para repasar.',
    'test.repas.emptyTitle': '¡Al día!',
    'test.repas.emptyDesc': 'No tienes preguntas pendientes de repaso ahora mismo. Vuelve cuando toque la próxima revisión, o haz un test para ir descubriendo fallos.',
  ...
  ca: {
    ...
    'test.list.repasDescAll': '{n} preguntes guardades. Torna quan toqui repassar.',
    'test.list.repasDescMastered': "Ben fet! Has dominat {n} preguntes. Continua practicant per acumular-ne més.",
    'test.list.repasDueShort': 'pendents',
    'test.list.repasTotalShort': 'guardades',
    'test.list.repasMasteredShort': 'dominades',
    'test.repas.title': 'Repàs de fallades',
    'test.repas.poolStatus': '{n} preguntes a punt per repassar.',
    'test.repas.emptyTitle': 'Al dia!',
    'test.repas.emptyDesc': "No tens preguntes pendents de repàs ara mateix. Torna quan toqui la propera revisió, o fes un test per descobrir-ne fallades.",
