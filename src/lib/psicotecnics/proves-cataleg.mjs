...
titol('1. Les catorze categories, amb cent ítems cadascuna');
{
  cal('n\'hi ha catorze', C.CATEGORIES.length === 14, `${C.CATEGORIES.length}`);
  cal('cap id repetit', new Set(C.CATEGORIES.map((c) => c.id)).size === 14);
