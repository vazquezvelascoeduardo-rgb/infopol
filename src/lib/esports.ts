    ...
    subsections: [
      {
        ...
        entries: [
          ...
          },
          {
            ...
            name: 'PSG, Bayern, Arsenal i Barça a semifinals',
            detail: 'F.C. Barcelona elimina Atlético de Madrid (3-2 global). PSG (campió defensor) elimina Liverpool (4-0). Arsenal elimina Sporting CP (1-0). Bayern de Múnich elimina Real Madrid (6-4). Semifinals: PSG vs Bayern · Arsenal vs Barça.',
          },
        ],
      },
      {
        ...
        entries: [
          {
            ...
            detail: 'França venç Anglaterra 48-46 al Stade de France amb un cop de càstig al darrer kop, executat per Thomas Ramos (màxim anotador del torneig). Louis Bielle-Biarrey (França) Jugador del Campionat amb 9 assajos (rècord en una sola edició).',
          },
        ],
      },
      {
