export default function Icon({ name, size = 22, color = 'currentColor', strokeWidth = 2 }) {
  ...
  switch (name) {
    ...
    case 'newspaper': return <svg {...common}><path d="M4 4h16a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z"/><path d="M7 8h10M7 12h10M7 16h6"/></svg>;
    case 'globe': return <svg {...common}><circle cx="12" cy="12" r="9"/><path d="M2 12h20M12 3a14 14 0 0 1 0 18M12 3a14 14 0 0 0 0 18"/></svg>;
