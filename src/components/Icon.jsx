export default function Icon({ name, size = 22, color = 'currentColor', strokeWidth = 2 }) {
  ...
  switch (name) {
    ...
    case 'newspaper': return <svg {...common}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 8h10M7 12h10M7 16h7"/></svg>;
    case 'globe': return <svg {...common}><circle cx="12" cy="12" r="9"/><path d="M12 3c-2 3-2 18 0 18M12 3c2 3 2 18 0 18M3 9h18M3 15h18"/></svg>;
