---
subtitol: Reial decret legislatiu 6/2015, de 30 d'octubre, text refós de la Llei sobre trànsit, circulació de vehicles a motor i seguretat viària · BOE-A-2015-11722
---

## Objecte i àmbit
> Articles 1 a 4

La **LSV** és la norma bàsica del trànsit a Espanya. És un ==**text refós**== aprovat pel ==**Reial decret legislatiu 6/2015, de 30 d'octubre**==, que va substituir el vell RDL 339/1990.

:::clau
La identificació de la norma es pregunta sempre: ==**RDL 6/2015, de 30 d'octubre**==. I recorda els tres reglaments que la desenvolupen, cadascun amb la seva data:
· ==**RD 1428/2003** — Reglament general de circulació.==
· ==**RD 818/2009** — Reglament general de conductors.==
· ==**RD 2822/1998** — Reglament general de vehicles.==
:::

L'**article 2** fixa l'==àmbit d'aplicació==: la llei s'aplica a tot el territori nacional i obliga els titulars i usuaris de les vies i terrenys ==públics aptes per a la circulació==, els ==privats que siguin utilitzats per una col·lectivitat indeterminada d'usuaris== i les vies i terrenys que, ==sense tenir aquesta aptitud, siguin d'ús comú==.

:::avis
Aquest article decideix moltes intervencions reals: un ==**pàrquing d'un centre comercial**== o el ==**vial d'una urbanització privada oberta**== són ==vies privades usades per una col·lectivitat indeterminada== i, per tant, ==**la LSV hi és aplicable**==. Un garatge particular tancat, no.
:::

## Les competències dels municipis
> Article 7

Aquest és el precepte que dona base a tota la teva feina de trànsit.

:::articles
a) | Trànsit a les vies urbanes
La ==**regulació, ordenació, gestió, vigilància i disciplina, per mitjà d'agents propis, del trànsit a les vies urbanes de la seva titularitat**==, així com la ==**denúncia** de les infraccions== que s'hi cometin i la ==**sanció**== d'aquestes quan no estigui expressament atribuïda a una altra administració.

b) | Ordenança municipal de circulació
La regulació, mitjançant ==ordenança municipal de circulació==, dels usos de les vies urbanes, fent compatible la distribució equitativa dels aparcaments amb la fluïdesa del trànsit rodat i l'ús per als vianants, i establint mesures d'==estacionament limitat== per garantir la rotació, amb atenció especial a les ==persones amb discapacitat i mobilitat reduïda==.

c) | Immobilització i retirada
La ==**immobilització** dels vehicles a les vies urbanes== quan no disposin de títol que habiliti l'estacionament en zones limitades o quan excedeixin de l'autorització, i la ==**retirada** dels vehicles== de les vies urbanes i el seu dipòsit.

d) | Autorització de proves esportives
L'==autorització de proves esportives== que discorrin exclusivament pel casc urbà.

e) | Tancament de vies
El ==tancament de vies urbanes== quan sigui necessari.

f) | Restricció de la circulació
La ==restricció de la circulació a determinades vies== per motius mediambientals o de calmat de trànsit.
:::

:::clau
La lletra a) conté les ==**cinc potestats municipals**== que has de saber recitar: ==**regulació, ordenació, gestió, vigilància i disciplina**== del trànsit a les vies urbanes. I la clau competencial: ==**vies urbanes de la seva titularitat**==. En una ==**travessia**== (via urbana la titularitat de la qual és d'una altra administració), el municipi ==**no** té la competència sancionadora== llevat que la via li hagi estat cedida.
:::

## Normes generals de conducció
> Articles 10 a 21
...
:::avis
L'obligació de sotmetre's a les proves ==**no és només del conductor**==: també hi estan obligats ==els altres usuaris de la via **implicats en un accident** o que hagin comès una infracció==, i els ==**vianants**== quan estiguin implicats en un accident. Negar-s'hi pot constituir el ==delicte de l'article 383 del Codi penal==, amb pena de presó de 6 mesos a 1 any.
:::
...
:::clau
Les xifres del carnet per punts que cauen totes juntes: ==**12** punts inicials== · ==**8** punts per als novells de menys de 3 anys i per als qui recuperen el permís== · ==**15** punts com a màxim== · ==**2 anys** per recuperar el saldo complet== · ==**6 punts** com a màxim per curs== · ==**6 mesos** (3 si és professional) per tornar a obtenir el permís perdut==.
:::

## Mesures provisionals: immobilització i retirada
...
:::avis
Els dos terminis de l'article 106 es confonen: ==**2 mesos al dipòsit**== per tractar-lo com a residu, i ==**1 mes al mateix lloc de la via** amb desperfectes== per considerar-lo abandonat. En tots dos casos cal ==requerir prèviament el titular== perquè el retiri, advertint-lo que en cas contrari es tractarà com a residu.
:::

## Les dades que sí es pregunten del règim sancionador
> Articles 74 a 80 i 112
...
:::clau
Compte amb tres confusions freqüents:
· La ==**reducció del 50 %**== del pagament voluntari en trànsit ==**no** és el 20 % + 20 %== de l'art. 85 de la Llei 39/2015. En trànsit mana la norma especial, i el termini és de ==**20 dies naturals**==.
· Els ==**punts no es redueixen mai**==: pagar aviat estalvia diners, no punts.
