---
subtitol: Constitució espanyola de 27 de desembre de 1978 · BOE-A-1978-31229
---
...
- **Títol III** (art. 66-96) — les Corts Generals.
- **Títol IV** (art. 97-107) — el Govern i l'Administració.
- **Títol V** (art. 108-116) — relacions entre Govern i Corts.
- **Títol VI** (art. 117-127) — el poder judicial.
- **Títol VII** (art. 128-136) — economia i hisenda.
- **Títol VIII** (art. 137-158) — organització territorial de l'Estat.
- **Títol IX** (art. 159-165) — el Tribunal Constitucional.
- **Títol X** (art. 166-169) — reforma constitucional.

:::clau
Dos articles fora del títol I que cauen sempre a les oposicions de policia:
**art. 104** (Forces i Cossos de Seguretat, dins del títol IV) i **art. 149.1.29a** (la seguretat pública com a competència exclusiva de l'Estat, dins del títol VIII).
:::
...
:::avis
No confonguis l'**art. 8** amb l'**art. 104**. L'art. 8 són les **Forces Armades** i parla de defensa: està al títol preliminar. L'art. 104 són les **Forces i Cossos de Seguretat** i parla de seguretat ciutadana: està al títol IV, dins del Govern i l'Administració. Cauen junts precisament per això.
:::

## L'estructura del títol I
> Dels drets i deures fonamentals · art. 10 a 55 CE

El títol I s'obre amb l'**article 10**, que no reconeix cap dret concret sinó que fixa el fonament de tots: la **dignitat de la persona**, els drets inviolables que li són inherents, el lliure desenvolupament de la personalitat, el respecte a la llei i als drets dels altres són **fonament de l'ordre polític i de la pau social**. El seu apartat 2 imposa interpretar les normes sobre drets fonamentals **de conformitat amb la Declaració Universal de Drets Humans** i els tractats ratificats per Espanya.

L'estructura del títol determina el nivell de protecció:

- **Art. 10** — pòrtic: dignitat i interpretació.
- **Capítol I** (art. 11-13) — dels espanyols i els estrangers.
- **Capítol II** (art. 14-38) — drets i llibertats.
  - **Art. 14** — igualtat davant la llei.
  - **Secció 1a** (art. 15-29) — drets fonamentals i llibertats públiques.
  - **Secció 2a** (art. 30-38) — drets i deures dels ciutadans.
- **Capítol III** (art. 39-52) — principis rectors de la política social i econòmica.
- **Capítol IV** (art. 53-54) — garanties.
...
El temps estrictament necessari i, en tot cas, màxim 72 hores per posar en llibertat o a disposició judicial.

art. 17.3 CE | Drets del detingut
Informació immediata i comprensible dels drets i les raons · dret a no declarar · assistència d'advocat.

art. 18.2 CE | Inviolabilitat del domicili
Tres úniques vies: consentiment del titular, resolució judicial o delicte flagrant.

art. 18.3 CE | Secret de les comunicacions
Només es pot aixecar per resolució judicial. No hi ha excepció de flagrància.
:::

:::avis
Compte amb la diferència entre l'art. 18.2 i el 18.3: al **domicili** hi ha tres vies (consentiment, resolució judicial o **flagrant delicte**); a les **comunicacions** només n'hi ha una, la **resolució judicial**. La flagrància no habilita a intervenir comunicacions.
:::
...
:::articles
art. 21 CE | Reunió
Pacífica i sense armes, sense autorització prèvia. Comunicació prèvia en llocs de trànsit públic.

art. 24.2 CE | Garanties del procés
Jutge predeterminat · defensa i lletrat · informació de l'acusació · sense dilacions indegudes · no declarar contra si mateix · presumpció d'innocència.

art. 25.1 CE | Legalitat penal
No hi ha delicte, falta ni infracció administrativa sense llei anterior al fet.

art. 25.3 CE | Límit a l'Administració
...
> Secció 2a · art. 30 a 38 CE

Aquesta secció ja **no** té recurs d'empara. Recull:

- **Art. 30** — dret i **deure de defensar Espanya**; objecció de consciència; deures dels ciutadans en casos de **greu risc, catàstrofe o calamitat pública** (30.4).
- **Art. 31** — deure de contribuir al sosteniment de les despeses públiques segons la **capacitat econòmica**, amb un sistema tributari just inspirat en **igualtat i progressivitat** i que **en cap cas tindrà abast confiscatori**.
- **Art. 32** — dret de l'home i la dona a contraure matrimoni amb **plena igualtat jurídica**.
- **Art. 33** — dret a la **propietat privada i a l'herència**, delimitat per la seva **funció social**; l'expropiació exigeix **causa justificada d'utilitat pública o interès social**, **indemnització** i conformitat amb les lleis.
- **Art. 35** — deure de treballar i dret al treball, lliure elecció de professió i remuneració suficient, sense discriminació per raó de sexe.
- **Art. 38** — **llibertat d'empresa** en el marc de l'economia de mercat.

:::clau
L'**art. 30.4** és el que dona cobertura constitucional als deures ciutadans en emergències — la base de tota la normativa de protecció civil que estudiaràs més endavant.
:::

## Principis rectors de la política social i econòmica
> Capítol III · art. 39 a 52 CE

No són drets exigibles directament: **informen** la legislació positiva, la pràctica judicial i l'actuació dels poders públics, i **només es poden al·legar davant la jurisdicció ordinària d'acord amb les lleis que els desenvolupin** (art. 53.3).

Els principals: protecció de la **família** i dels **fills** (art. 39); **progrés social i econòmic**, formació professional i **descans necessari** amb limitació de la jornada (art. 40); règim públic de **Seguretat Social** (art. 41); **protecció de la salut** (art. 43); accés a la **cultura** (art. 44); **medi ambient** adequat, amb el **deure de conservar-lo** (art. 45); **patrimoni històric, cultural i artístic** (art. 46); **habitatge digne i adequat** (art. 47); participació de la **joventut** (art. 48); drets de les **persones amb discapacitat** en condicions de llibertat i igualtat reals (art. 49); **suficiència econòmica en la tercera edat** mitjançant pensions adequades i periòdicament actualitzades (art. 50); i defensa dels **consumidors i usuaris** (art. 51).

## Garanties i suspensió dels drets
> Capítol IV i V · art. 53 a 55 CE

L'**article 53** estableix **tres nivells** de protecció, i entendre'ls és la clau de tot el títol:

1. **Art. 14 i secció 1a (15-29)** — vinculen tots els poders públics; només per llei que respecti el **contingut essencial**; tutela pels tribunals ordinaris per **procediment preferent i sumari** i **recurs d'empara** davant del Tribunal Constitucional. L'empara s'aplica també a l'**objecció de consciència** de l'art. 30.
2. **Resta del capítol II (30-38)** — vinculen els poders públics i només es regulen per llei que respecti el contingut essencial, **però sense empara**.
3. **Capítol III (39-52)** — informen la legislació i l'actuació dels poders públics; **només al·legables** segons les lleis que els desenvolupin.

L'**article 54** crea el **Defensor del Poble**, alt comissionat de les Corts Generals designat per elles per a la defensa dels drets d'aquest títol, amb facultat de **supervisar l'activitat de l'Administració** i donar-ne compte a les Corts.

L'**article 55** regula la suspensió i distingeix dos supòsits que no s'han de barrejar:

**Suspensió general** (55.1), quan es declara l'**estat d'excepció o de setge**. Afecta els articles **17, 18.2 i 18.3, 19, 20.1.a) i d) i 20.5, 21, 28.2 i 37.2**. S'exceptua l'**art. 17.3** en el supòsit d'estat d'excepció.

**Suspensió individual** (55.2), per **llei orgànica**, de forma individual, amb **intervenció judicial necessària i control parlamentari adequat**, per a persones determinades en relació amb investigacions de **bandes armades o elements terroristes**. Afecta els art. **17.2 i 18.2 i 18.3**.
...
:::articles
art. 137 CE | Organització territorial
Municipis, províncies i comunitats autònomes. Totes amb autonomia per gestionar els seus interessos.

art. 140 CE | Autonomia municipal
Personalitat jurídica plena. Ajuntaments d'alcalde i regidors. Regidors per sufragi universal; alcalde pels regidors o pels veïns.

art. 141 CE | La província
...
L'**article 143** obre la via general d'accés a l'autonomia: **províncies limítrofes** amb característiques històriques, culturals i econòmiques comunes, territoris insulars i províncies amb entitat regional històrica. L'**article 147** defineix els **estatuts d'autonomia** com la **norma institucional bàsica** de cada comunitat, que l'Estat reconeix i empara com a part del seu ordenament. L'**article 145.1** prohibeix taxativament la **federació de comunitats autònomes**.

El repartiment competencial és el nucli del títol. L'**article 148** llista les matèries que les comunitats **poden assumir**; l'**article 149.1** enumera les de **competència exclusiva de l'Estat** — entre elles la **seguretat pública** (149.1.29a), amb la reserva expressa que això no impedeix la creació de policies autonòmiques. L'**article 150** preveu les lleis marc, les de transferència o delegació i les d'harmonització.

L'**article 152** fixa l'organització institucional de les comunitats d'autonomia plena: **Assemblea Legislativa** elegida per sufragi universal amb representació proporcional, un **Consell de Govern** amb funcions executives i administratives, un **president** i un **Tribunal Superior de Justícia**.

El **control** de l'activitat de les comunitats (art. 153) correspon al **Tribunal Constitucional** (constitucionalitat de les disposicions amb força de llei), al **Govern** amb dictamen del Consell d'Estat (competències delegades), a la **jurisdicció contenciosa administrativa** (administració autònoma i els seus reglaments) i al **Tribunal de Comptes** (econòmic i pressupostari).

L'**article 155** conté el mecanisme excepcional: si una comunitat **no compleix** les obligacions que la Constitució o les lleis li imposen, o actua de forma que **atempti greument contra l'interès general d'Espanya**, el Govern —previ requeriment al president de la comunitat i amb **aprovació per majoria absoluta del Senat**— pot adoptar les mesures necessàries per obligar-la al compliment forçós.

:::clau
Per a l'examen, reté aquesta cadena: **art. 137** (organització territorial) → **art. 140** (autonomia municipal) → **art. 141** (província) → **art. 149.1.29a** (seguretat pública com a competència estatal amb reserva de policies autonòmiques). És l'esquelet que connecta la Constitució amb la Llei de policies locals que estudiaràs al bloc de seguretat.
:::

:::avis
Aquest material d'estudi s'ha elaborat a partir del **text consolidat publicat al BOE** (BOE-A-1978-31229). **No és una font oficial**: per a qualsevol actuació professional, consulta sempre el text vigent al BOE.
:::
