---
subtitol: Llei 16/1991, de 10 de juliol, de les policies locals de Catalunya · text consolidat
---

## Àmbit d'aplicació i naturalesa
> Títol 1, capítol 1 · articles 1 a 7
...
art. 3.1 | Quan hi pot haver cos
Municipis de més de 10.000 habitants. Per sota, cal majoria absoluta i autorització.

art. 5.2 | Sortir del municipi
...
:::clau
Tres decisions que la llei posa en mans de l'**alcalde**: determinar motivadament quan no es duen armes de foc (8.2), autoritzar serveis sense uniforme (9.2) i exercir el comandament del cos (4.2). Retén qui decideix cada cosa.
:::

## Principis d'actuació
> Article 10

L'**article 10** recull els principis bàsics d'actuació dels policies locals. Segueixen l'esquema de l'**art. 5 de la LOFCS**, amb una diferència que cal notar: aquí el respecte s'estén expressament a **la Constitució, l'Estatut d'Autonomia i la resta de l'ordenament jurídic**, mentre que la LOFCS només esmenta la Constitució.

Els blocs són els mateixos: adequació a l'ordenament jurídic — amb la **neutralitat política i imparcialitat** i el límit de l'obediència deguda —, relacions amb la comunitat, tractament dels detinguts, dedicació professional, secret professional i responsabilitat.

:::clau
Quan a l'examen et preguntin pels principis d'actuació, fixa't **de quina llei** parla l'enunciat. Si és la **16/1991**, la referència inclou l'**Estatut d'Autonomia**; si és la **LOFCS**, no.
:::

## Les funcions de la policia local
> Article 11 · les tretze funcions
...
:::clau
Les quatre funcions que la **16/1991 afegeix** respecte de la LOFCS: **medi ambient** (k), **seguretat viària** (l), la clàusula oberta (m) i el fet que **vigilar espais públics** (i) sigui una funció autònoma, no condicionada a requeriment. Compara-ho amb l'art. 53.1 LOFCS, on la vigilància d'espais públics va unida a la col·laboració en manifestacions.
:::

:::avis
Fixa't en quines funcions porten **deure de comunicar**: els atestats per accident (c) i les diligències de prevenció (f). I quines exigeixen **requeriment previ**: la col·laboració en manifestacions (g) i la cooperació en conflictes privats (h). No són intercanviables.
:::

## Policia judicial i vigilants
> Articles 12 i 13
...
:::clau
Al **12.1.a** cal **requeriment**; al **12.1.b** es pot actuar **per iniciativa pròpia**. Aquesta distinció és el nucli de la participació de la policia local en la policia judicial: les primeres diligències no esperen ordre.
:::

L'**article 13** delimita què poden fer **els vigilants**, i és una llista **tancada** de quatre actuacions: custodiar i vigilar béns, serveis, instal·lacions i dependències municipals; **ordenar i regular el trànsit** dins el nucli urbà; participar en tasques d'**auxili al ciutadà i protecció civil**; i vetllar pel compliment de reglaments, ordenances, bans, resolucions i altres disposicions i actes municipals.

:::avis
Compara l'art. 13 amb l'art. 11: els vigilants **no** instrueixen atestats, **no** exerceixen de policia judicial, **no** fan diligències de prevenció i **no** poden dur armes de foc (art. 8.3). La diferència entre policia local i vigilant no és de grau, és de naturalesa.
:::

## La coordinació de les policies locals
> Títol 2 · articles 14 i 15

L'**article 14** defineix què és la **coordinació** als efectes d'aquesta llei: la determinació dels **mitjans i sistemes de relació** que fan possible l'**acció conjunta** de les policies locals, mitjançant les autoritats competents, de manera que s'aconsegueixi la **integració de les actuacions particulars** dins del conjunt del sistema de seguretat ciutadana.

L'**article 15** enumera fins on es pot estendre aquesta coordinació: promoure l'**homogeneïtzació dels mitjans tècnics** i la uniformitat dels elements comuns; establir els instruments d'un **sistema d'informació recíproca**; **assessorar** les policies locals i els municipis que ho sol·licitin; canalitzar la **col·laboració entre administracions** per a necessitats temporals o extraordinàries; **coordinar les actuacions en protecció civil**; i establir les **normes essencials d'estructura i organització interna** a què s'han d'ajustar les policies locals, així com la normativa d'accés i formació.

:::clau
Coordinar **no és manar**. L'art. 14 parla de "mitjans i sistemes de relació" per a l'"acció conjunta": la Generalitat coordina, però el **comandament** de cada cos segueix sent de l'**alcalde** (art. 4.2). Respectar l'autonomia municipal és el fil conductor de tota la llei.
:::

## Escales i categories
> Article 24 · l'estructura del cos

L'**article 24** estructura els cossos de policia local en **quatre escales**:
...
L'**article 25** atribueix als **municipis** l'aprovació de la **plantilla** del cos, que ha d'integrar tots els llocs de treball de cada categoria i **adequar l'estructura a les escales i categories** d'aquesta llei.

:::avis
Compte amb els grups: l'escala **intermèdia** i la **bàsica** estan **totes dues** al grup C, subgrup C1. No és un error de transcripció — la diferència entre elles és de **categoria**, no de grup.
:::
