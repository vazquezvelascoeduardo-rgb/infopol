...
:::avis
La responsabilitat per danys de l'art. 4.3 és **directa del participant** i només **subsidiària** de l'organitzador — i aquesta decau si va posar tots els mitjans raonables. No es pot atribuir automàticament el dany a qui convoca.
:::
...
:::clau
L'apartat **b)** no diu "alteració de l'ordre públic" a seques: exigeix **alteració amb perill per a persones o béns**. Les molèsties, el soroll o el tall de trànsit per si sols no encaixen en aquest supòsit. És el punt que decideix la legalitat d'una dissolució.
:::

## Reunions en llocs tancats
> Articles 6è i 7è
...
- **a)** **Nom, cognoms, domicili i document oficial** d'identificació dels organitzadors o del seu representant (i, per a persones jurídiques, denominació, naturalesa i domicili).
- **b)** **Lloc, data, hora i durada** prevista.
- **c)** **Objecte** de la reunió.
...
· **10 a 30 dies** — antelació ordinària de la comunicació.
· **24 hores** — antelació mínima en cas urgent, i també el termini de l'informe municipal.
· **72 hores** — màxim per notificar la prohibició o modificació.
· **48 hores** — per interposar el recurs contenciós administratiu.
:::
...
:::avis
Aquest material d'estudi s'ha elaborat a partir del **text consolidat publicat al BOE** (BOE-A-1983-19946). **No és una font oficial**: per a qualsevol actuació professional, consulta sempre el text vigent al BOE.
:::
