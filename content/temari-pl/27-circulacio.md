---
subtitol: Reial decret 1428/2003, de 21 de novembre, pel qual s'aprova el Reglament general de circulació · BOE-A-2003-23514
---

## Què regula
> Objecte

El **Reglament general de circulació** és el que diu ==**com s'ha de circular**==: velocitats, prioritats, avançaments, parada i estacionament, vianants, senyalització i enllumenat. És, de tots els reglaments de trànsit, el que faràs servir cada dia.

:::clau
==**RD 1428/2003, de 21 de novembre**==. Ha estat molt modificat; les reformes que més has de tenir presents són el ==**RD 970/2020**== (velocitats urbanes de 20/30/50 km/h i mesures urbanes de trànsit) i el ==**RD 465/2025**== (senyalització de trànsit).
:::

## Begudes alcohòliques i drogues
> Articles 20 a 28
...
· ==Els qui, per **indicis**, siguin requerits pels agents en **controls preventius**.==
:::

:::clau
Els quatre supòsits de l'article 21 són els que has de saber recitar quan et pregunten a qui pots fer la prova. I fixa't en dues coses:
· ==Les taxes es refereixen a **superar**, no a assolir: 0,25 mg/l exactes **no** superen el límit.==
· ==Els **ciclistes** hi estan sotmesos igual que els conductors de vehicles de motor== (art. 20). Molta gent creu que no.
· El llindar administratiu (==0,25 mg/l==) i el penal (==més de 0,60 mg/l==, art. 379.2 CP) són ==**diferents**==: entre un i altre hi ha infracció administrativa, per damunt hi ha delicte.
:::
...
:::avis
Els límits urbans ==**20 / 30 / 50**== són la modificació del ==**RD 970/2020**==, en vigor des del ==**11 de maig de 2021**==. Qualsevol test que digui que el límit genèric urbà és de 50 km/h "amb caràcter general" ==està desactualitzat==: avui el ==50 només s'aplica a vies de **dos o més carrils per sentit**==, i la immensa majoria de carrers d'un poble o ciutat són de ==**30**==.
:::
...
:::clau
Les ==**quatre excepcions de la dreta**== de l'article 57 són pregunta segura: ==**pavimentada** sobre no pavimentada · **rails** sobre tot · dins de la **glorieta** sobre qui hi entra · **autopista/autovia** sobre qui hi accedeix==. Nota que la preferència del vehicle que circula per rails és ==**absoluta**==, fins i tot davant d'un que vingui per la dreta.
:::

## Avançament
> Articles 82 a 90

La norma general (art. 82): l'avançament s'ha de fer ==**per l'esquerra**== del vehicle que es vol avançar. ==**Per excepció** es fa per la dreta== quan el vehicle avançat ==indiqui clarament el propòsit de girar a l'esquerra o parar en aquest costat==, i a les vies amb circulació en tots dos sentits quan hi hagi ==espai suficient== i el vehicle avançat estigui esperant per girar.

Abans d'iniciar la maniobra (art. 84), el conductor ha d'==advertir-ho amb prou antelació amb les senyals preceptives== i ==comprovar que al carril que pretén utilitzar hi ha espai lliure suficient== per no posar en perill ni entorpir els qui circulen en sentit contrari. ==Cap conductor ha d'avançar diversos vehicles si no té la **total seguretat** que pot tornar al seu carril sense perjudici==.

:::avis
En avançar ==**vianants, animals, vehicles de tracció animal, ciclomotors, vehicles de mobilitat personal o ciclistes**== (art. 87.4), el conductor ha d'==ocupar **part o la totalitat del carril contigu o contrari**== i guardar una ==amplada de seguretat de **com a mínim 1,5 metres**==. Si la calçada té ==**més d'un carril per sentit**, és **obligatori el canvi complet de carril**==. I si l'avançament es fa ==**fora de poblat**==, cal ==**reduir la velocitat en almenys 20 km/h**== respecte del límit de la via, abans d'iniciar la maniobra i durant tota la seva execució. Els ciclistes que circulen ==**en grup es consideren una única unitat mòbil**==.
:::
...
d) ==Interseccions i les seves proximitats== si es dificulta el gir o hi ha manca de visibilitat.
e) ==Sobre els rails de tramvia== o tan a prop que se'n pugui entorpir la circulació.
f) ==Llocs on s'impedeixi la visibilitat de la senyalització== als altres usuaris.
g) ==Carrils de sentit contrari en calçades de doble sentit.==
h) ==Trams senyalitzats amb marca vial longitudinal contínua== sense espai per a la circulació.
...
:::clau
La distinció ==**parada / estacionament**== és el fonament de tot: la **parada** és una immobilització ==**inferior a dos minuts**== sense que el conductor abandoni el vehicle; l'**estacionament** és tota altra immobilització que ==no sigui parada ni motivada per necessitats de la circulació==. Per això ==**tot lloc on està prohibit parar ho està també per estacionar**==, però no a l'inrevés.
:::
...
:::avis
La regla del ==**voral esquerre**== per als vianants és contraintuïtiva i cau sovint: el vianant camina ==**contra el sentit de la circulació**==, per veure venir els vehicles. Els **ciclistes**, en canvi, circulen pel ==**voral dret**== (art. 36), en el mateix sentit que el trànsit.
:::
...
:::clau
Aquest ordre és **la pregunta de senyalització per excel·lència** i es demana literalment. Regla per fixar-lo: ==**agent → obres → semàfor → vertical → marca vial**==. En cas de contradicció entre senyals, ==preval la preferent segons aquest ordre==; i entre senyals del mateix tipus, ==preval la més restrictiva==.
:::
